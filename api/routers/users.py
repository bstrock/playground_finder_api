...
async def create_user(
    ...
    # otherwise, make the user in the database
        ...
        user = schema_to_row(incoming_user, User)  # convert incoming user schema to table object
        user.hashed_password = pwd_context.hash(user.hashed_password)  # hash password before sending to db
